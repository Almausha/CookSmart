...
import { ChefHat, ArrowRight, Zap, LogOut, BookOpen, Loader2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen relative flex flex-col items-center justify-center font-sans overflow-hidden py-10 bg-background text-foreground">
      ...
      <div className="relative z-10 max-w-6xl w-full px-6 text-center">
        ...
        {isHome ? (
          /* --- VIEW A: Landing View (Welcome Screen) --- */
          <div className="bg-card/10 backdrop-blur-2xl rounded-[3.5rem] border border-white/20 p-12 shadow-2xl relative overflow-hidden animate-in fade-in zoom-in-95 duration-500">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                className="group relative bg-primary hover:opacity-90 text-primary-foreground px-8 py-5 rounded-2xl font-black text-xl transition-all shadow-xl shadow-primary/40 flex items-center gap-3 active:scale-95 border-none cursor-pointer"
              >
              ...
              <button
                ...
                className="group bg-white/5 hover:bg-white/10 text-white border border-white/20 px-8 py-5 rounded-2xl font-black text-xl transition-all flex items-center gap-3 active:scale-95 cursor-pointer"
              >
          ...
          /* --- VIEW B: Clean Outlet (Sub-pages display) --- */
        ...
        <div className="mt-12 flex flex-col items-center gap-4">
          <button 
            onClick={logoutUser} 
            className="flex items-center gap-2 text-white/40 hover:text-destructive transition-colors font-bold uppercase tracking-widest text-[10px] group bg-transparent border-none cursor-pointer shadow-none p-2"
          >
