...
import { ShoppingCart, CheckCircle, ArrowLeft, Loader2, Clock, Flame, AlertTriangle } from "lucide-react";
        ...
        <div className="lg:col-span-2 space-y-8 text-left">
          ...
          <div className="flex flex-wrap gap-4">
            <div className="bg-white/5 px-6 py-3 rounded-2xl border border-white/10 flex items-center gap-3">
              ...
              <span className="text-white font-bold">{recipe.cookingTime}</span>
            </div>
            <div className="bg-white/5 px-6 py-3 rounded-2xl border border-white/10 flex items-center gap-3">
